...
import firstAttempt.Bot;
import firstAttempt.Utils.Items;
...
public class ActionsMenu extends BotMenu {
	...
	public static ItemStack respawn = Items.createItem(Material.SKELETON_SKULL, 1, 0, "§a§lRespawn");
